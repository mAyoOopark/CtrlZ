label chapter5_1:
    ...
    hajun "너는 묵비권을 행사 할 수 있고, 변호사를 선임 할 수 있으며, 모든 발언은 법정에서 불리하게 작용할 수 있다."
    ...
    "선배가 건물에 있던 아이들을 보호하고 간단한 조사 후에 보육 시설에 나눠서 보냈다고 했다."
    "최민재를 조사하던 중, 아이들의 배후에 최도현이 있었다는 것을 알게 되었지만,"
    "최민재는 촉법 소년이였기 때문에 조사 후 지속적으로 감시를 받으며 보육 시설에 보내질 예정이었다."
    ...
    "민재는 보육 시설의 사람들 몇 명을 죽이고 보육 시설을 조용히 빠져나갔다."
    "그 후, 각각 다른 시설에 보낸 아이들이 하나 둘 씩 실종되었다는 소식이 들려왔다.."
    "과연 아이들은 어디로 사라진 것인가.."
