label chapter5_2:
    ...
    "나는 온갖 생각이 스쳐갔다."
    "형님이 잘못된게 아닐까..?"
    "내가 놓친 최민재에게 당한 게 아닐까..?"
    "그 장면을 본 나는 무너져 내릴 수 밖에 없었다."
    "등이 칼에 찔려 벽에 기대어 있었고, 등에서 뿜어져 나오는 피가 벽에 묻어 마치 날개 처럼 보이는 듯 했다."
    "형님은 숨소리보다 작은 소리로 속삭이며 최민재의 이름을 말했고, 내가 에상한 일들이 정말로 벌어진 것이었다."
    "그렇게 과다 출혈로 인한 쇼크로 인해 남종식 형님은 장례를 치루게 되었고, 최하람을 제외한 모두를 놓치게 되었다."
